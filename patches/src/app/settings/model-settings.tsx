  ...
  return (
    <div className="grid gap-6">
            ...
            setupIsApiKey ? (
              <>
                <Input
                  ...
                  placeholder={t.settings.credentials.pasteLabelKey(selectedProviderRow?.key_env ?? 'API key')}
                  type="password"
                  value={apiKeyDraft}
                />
                <Button
      ...
      {moa && currentMoaPreset && (
        <section>
          <SectionHeading icon={Cpu} title={t.settings.model.moaTitle} />
          <p className="mb-2 text-xs text-muted-foreground">
            {t.settings.model.moaDesc}
          </p>
          <div className="mb-2 flex flex-wrap items-center gap-2">
            <Select onValueChange={setSelectedMoaPreset} value={selectedMoaPreset || moa.default_preset}>
              <SelectTrigger className={cn('min-w-40', CONTROL_TEXT)}>
                <SelectValue placeholder={t.settings.model.moaPreset} />
              </SelectTrigger>
              <SelectContent>
            ...
            <Input
              ...
              placeholder={t.settings.model.moaNewPreset}
          ...
          <div className="grid gap-1">
            ...
            <ListRow
              ...
              title={t.settings.model.moaAggregator}
            />
          </div>
        </section>
      )}
